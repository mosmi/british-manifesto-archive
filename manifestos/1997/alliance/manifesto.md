...
If we are ever to reach a negotiated settlement, the parties must be committed to Talks and an honorable compromise. The issues must be resolved through the force of argument, rather than the use of violence. The Alliance Party remains fully committed to the Mitchell Principles as the basis for the current Talks. It is regrettable that the strength of those principles has been diluted by the actions of certain parties and the response of the two governments.

Alliance fully supports the recommendations of the Mitchell Report that decommissiomng occur alongside talks, in the context of ceasefire from both sets of paramilitaries.

##### Decommissioning

Decommissioning is fundamentally a political issue. Alliance recognises the importance of the neutralizing illegally held arms to reduce the prospects of violence in our society. However the possession of arms is not the core of the conflict within Northern Ireland. Like terrorism itself, it is only a symptom of a much wider political problem; decommissioning cannot by itself put an end terrorism. There are clear practical limitations to decommissioning. There can never be any guarantee that it has been completed by either set of paramilitaries.

Decommissioning should be viewed as both a means of reducing the threat of terrorism and as a confidence building measure. The acceptance of the principle of and implementation of decommissioning by the paramilitiaries, like the acceptance of the Mitchell Principles and the principle of consent by parties associated with paramilitarism, would go a long way to providing the necessary confidence that the ceasefire were genuine.
...
- Availability of Nursery School places, properly funded, for all under fives.
- Opposition to the continued erosion of student funding.
- The extension of adult learning facilities and accreditation for vocational qualifications, including NVQS and GNVQ'S.
...
- NVQ systems should be expanded to encourage the over 35 age group, and financial support during training and restraining should reflect current wage levels rather than social security benefits.
...
Alliance would welcome more integrated ticketing between various transport companies, which would facilitate both local travelers and tourists.
...
Alliance will continue to press the Department of Environment to assume a more proactive role in facilitating recycling activities. Councils should also be more innovative in this area and extensive programmed to educate the population, particularly school children, in recycling and waste minimisation are required. A regional strategy for the disposal of waste is now a matter of urgency,
...
Alliance is concerned that improvements in combating urban housing decay have not been matched in the rural housing stock, which now accounts for much of the worst housing conditions in Northern Ireland. More resources need to be directed towards rural unfitness. Failure to do this can only lead to further rural depopulation and more urban overcrowding.
...
Alliance supports the EU directives on social and economic equality for women.

Alliance believes all women should be enabled to realise their full potential and achieve fulfillment at home, in employment and in public life.
...
- Career development programmed for people with disabilities.
...
- Assistance with long-term self-help programmed in the developing world, rather than the current emphasis on short-term responses to emergencies.
...
The Alliance Party of Northern Ireland
88 University Street, Belfast, BT7 lHE
Tel 01232 324274 Fax 01232 333147
e-mail alliance@unite.net
