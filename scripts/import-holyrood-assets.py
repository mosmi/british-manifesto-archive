#!/usr/bin/env python3
"""
Import Holyrood election manifesto PDFs from the local source archive into
manifestos/holyrood/{id}/{party}/...

Driven by scripts/holyrood-assets.json (same schema as london-assets.json).
...
MANIFEST = Path(__file__).resolve().parent / "holyrood-assets.json"
DEST_ROOT = ROOT / "manifestos" / "holyrood"
