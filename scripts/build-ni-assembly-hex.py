...
RESULTS = {
    1998: {
        "Belfast East":                  ["dup", "dup", "uup", "uup", "alliance", "pup"],
        "Belfast North":                 ["dup", "uup", "sinnfein", "sdlp", "pup", "independent"],
        "Belfast South":                 ["uup", "uup", "sdlp", "sdlp", "dup", "niwc"],
        "Belfast West":                  ["sinnfein", "sinnfein", "sinnfein", "sinnfein", "sdlp", "sdlp"],
        "East Antrim":                   ["uup", "uup", "dup", "sdlp", "alliance", "ukup"],
        "East Londonderry":              ["uup", "uup", "sdlp", "sdlp", "dup", "independent"],
        "Fermanagh and South Tyrone":    ["uup", "uup", "sinnfein", "sinnfein", "dup", "sdlp"],
        "Foyle":                         ["sdlp", "sdlp", "sdlp", "sinnfein", "sinnfein", "dup"],
        "Lagan Valley":                  ["uup", "uup", "dup", "sdlp", "alliance", "ukup"],
        "Mid Ulster":                    ["sinnfein", "sinnfein", "sinnfein", "dup", "uup", "sdlp"],
        "Newry and Armagh":              ["sinnfein", "sinnfein", "sdlp", "sdlp", "dup", "uup"],
        "North Antrim":                  ["dup", "dup", "dup", "uup", "uup", "sdlp"],
        "North Down":                    ["uup", "uup", "uup", "alliance", "ukup", "niwc"],
        "South Antrim":                  ["uup", "uup", "dup", "sdlp", "alliance", "ukup"],
        "South Down":                    ["sdlp", "sdlp", "sdlp", "dup", "uup", "sinnfein"],
        "Strangford":                    ["dup", "dup", "uup", "uup", "alliance", "ukup"],
        "Upper Bann":                    ["uup", "uup", "dup", "sinnfein", "sdlp", "independent"],
        "West Tyrone":                   ["sinnfein", "sinnfein", "sdlp", "sdlp", "dup", "uup"],
    },
    2003: {
    ...
    2007: {
        ...
        "Belfast North":                 ["dup", "dup", "sinnfein", "sinnfein", "uup", "sdlp"],
        "Belfast South":                 ["sdlp", "sdlp", "dup", "uup", "sinnfein", "alliance"],
        "Belfast West":                  ["sinnfein", "sinnfein", "sinnfein", "sinnfein", "sinnfein", "sdlp"],
        "East Antrim":                   ["dup", "dup", "dup", "uup", "uup", "alliance"],
        "East Londonderry":              ["dup", "dup", "dup", "uup", "sinnfein", "sdlp"],
        "Fermanagh and South Tyrone":    ["dup", "dup", "sinnfein", "sinnfein", "uup", "sdlp"],
        "Foyle":                         ["sdlp", "sdlp", "sdlp", "sinnfein", "sinnfein", "dup"],
        "Lagan Valley":                  ["dup", "dup", "dup", "uup", "sinnfein", "alliance"],
        "Mid Ulster":                    ["sinnfein", "sinnfein", "sinnfein", "dup", "uup", "sdlp"],
        "Newry and Armagh":              ["sinnfein", "sinnfein", "sinnfein", "dup", "uup", "sdlp"],
        "North Antrim":                  ["dup", "dup", "dup", "uup", "sinnfein", "sdlp"],
        "North Down":                    ["dup", "dup", "uup", "uup", "alliance", "gpni"],
        "South Antrim":                  ["dup", "dup", "uup", "sinnfein", "sdlp", "alliance"],
        "South Down":                    ["sinnfein", "sinnfein", "sdlp", "sdlp", "dup", "uup"],
        "Strangford":                    ["dup", "dup", "dup", "dup", "uup", "alliance"],
        "Upper Bann":                    ["dup", "dup", "uup", "uup", "sinnfein", "sdlp"],
        "West Tyrone":                   ["sinnfein", "sinnfein", "sinnfein", "dup", "dup", "independent"],
    },
    2011: {
        ...
        "Belfast South":                 ["sdlp", "sdlp", "dup", "uup", "sinnfein", "alliance"],
        "Belfast West":                  ["sinnfein", "sinnfein", "sinnfein", "sinnfein", "sinnfein", "sdlp"],
        "East Antrim":                   ["dup", "dup", "dup", "uup", "sinnfein", "alliance"],
        ...
        "Mid Ulster":                    ["sinnfein", "sinnfein", "sinnfein", "dup", "uup", "sdlp"],
        "Newry and Armagh":              ["sinnfein", "sinnfein", "sinnfein", "dup", "uup", "sdlp"],
        "North Antrim":                  ["dup", "dup", "dup", "uup", "sinnfein", "tuv"],
        "North Down":                    ["dup", "dup", "dup", "uup", "alliance", "gpni"],
        "South Antrim":                  ["dup", "dup", "dup", "uup", "sinnfein", "alliance"],
        "South Down":                    ["sinnfein", "sinnfein", "sdlp", "sdlp", "dup", "uup"],
        "Strangford":                    ["dup", "dup", "dup", "uup", "uup", "alliance"],
        "Upper Bann":                    ["dup", "dup", "uup", "uup", "sinnfein", "sdlp"],
    ...
    2017: {
        ...
        "Lagan Valley":                  ["dup", "dup", "uup", "sdlp", "alliance"],
        "Mid Ulster":                    ["sinnfein", "sinnfein", "sinnfein", "dup", "sdlp"],
        "Newry and Armagh":              ["sinnfein", "sinnfein", "sinnfein", "dup", "sdlp"],
        "North Antrim":                  ["dup", "dup", "uup", "sinnfein", "tuv"],
        "North Down":                    ["dup", "dup", "uup", "alliance", "gpni"],
        "South Antrim":                  ["dup", "dup", "uup", "sinnfein", "alliance"],
        "South Down":                    ["sinnfein", "sinnfein", "sdlp", "sdlp", "dup"],
        "Strangford":                    ["dup", "dup", "dup", "uup", "alliance"],
        "Upper Bann":                    ["dup", "dup", "uup", "sinnfein", "sdlp"],
...
# Plurality (largest-seat) party per constituency, used for the hex colour.
# Ties are resolved to the party that topped first-preference votes.
PLURALITY_PARTY = {
    1998: {
